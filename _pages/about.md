...
<p align="justify">Welcome to my homepage! I am a Team Lead and Senior Scientist at the Centre for Frontier AI Research (<a href="https://www.a-star.edu.sg/cfar">CFAR</a>), Agency for Science, Technology and Research (<a href="https://www.a-star.edu.sg/">A*STAR</a>), Singapore, where I lead the Trustworthy AI team, advancing safety, robustness, privacy, and governance in AI to support responsible real-world deployment and application. I am also a Senior Member of the IEEE and serving as an Associate Editor of <i>IEEE Transactions on Neural Networks and Learning Systems</i>. Before joining CFAR, I was with the Institute of High Performance Computing (IHPC), A*STAR, from January 2019 to June 2026. I received my PhD in Computer Science from Sichuan University in December 2018, under the supervision of <a href="https://scholar.google.com/citations?user=0gupif8AAAAJ&hl=en">Professor Dezhong Peng</a>. From 2016 to 2018, I was a joint PhD student at the University of Birmingham, supervised by <a href="https://scholar.google.com/citations?hl=en&user=UUtYPl4AAAAJ">Professor Xin Yao</a>.</p>
...
<ul align="justify">
  <li>[Sept 2026] Our paper on FlowLeak: Coverage-Guided Extraction of Dynamic Workflows in LLM-Based Multi-Agent Systems has been accepted for publication at <i>NeurIPS 2026</i>.</li>
  <li>[Sept 2026] Our paper on Dual-Dynamic In-Context Learning for Medical Image Segmentation has been accepted for publication at <i>IEEE Transactions on Medical Imaging</i>.</li>
  <li>[Jul 2026] Today, A*STAR launches the Institute of Advanced Intelligence and Computing (IAIC), bringing together the strengths of IHPC and I²R. I have joined CFAR in IAIC.</li>
